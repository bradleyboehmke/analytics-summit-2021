...
* Deep Learning with Keras and TensorFlow `r fontawesome::fa("python")` `r fontawesome::fa("r-project")` [`r fontawesome::fa("link", height = 15, fill = 'lightgrey')`](https://github.com/rstudio-conf-2020/dl-keras-tf)
* Delivering Data Science Products via Packages `r fontawesome::fa("python")` `r fontawesome::fa("r-project")` [`r fontawesome::fa("link", height = 15, fill = 'lightgrey')`](https://github.com/misk-data-science/misk-packages)
...
* Interpretable Machine Learning `r fontawesome::fa("r-project")` [`r fontawesome::fa("link", height = 15, fill = 'lightgrey')`](https://github.com/bradleyboehmke/CinDay-RUG-IML-2018)
...
* Open collaboration --> Faster innovation

* Code reduction --> Less tech debt

* Code consistency --> Better governance

* Simple & common interfaces --> Faster delivery

* Baked in best practices --> Resource efficiency

* Modular --> Establish 'lego' building blocks
